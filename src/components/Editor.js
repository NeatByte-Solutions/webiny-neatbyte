...
export function Editor({ filename, children }) {
  return (
    <div className="mt-[3.75rem] mb-[3.75rem] first:mt-0 last:mb-0 bg-medium-slate-blue rounded-xl shadow-lg overflow-hidden dark:ring-1 dark:ring-white/10 dark:ring-inset">
