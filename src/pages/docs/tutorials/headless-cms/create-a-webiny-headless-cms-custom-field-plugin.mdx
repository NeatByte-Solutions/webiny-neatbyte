...
1. Create `fields/secretText` directory in <WordWrapper>`apps/admin/code/src/plugins/headlessCMS`</WordWrapper>.
...
3. Import this new plugin in <WordWrapper>`apps/admin/code/src/plugins/headlessCms.ts`</WordWrapper>.
...
1. Create a file [`secretTextFieldRendererPlugin.tsx`](https://github.com/webiny/webiny-examples/blob/master/headless-cms/custom-field-plugin/ui/secretTextFieldRendererPlugin.tsx) in <WordWrapper>`apps/admin/code/src/plugins/headlessCMS/fields/secretText`</WordWrapper> directory.
...
1. Open the <WordWrapper>`api/code/headlessCMS/src/fields/secretText/secretTextFieldStoragePlugin.ts`</WordWrapper> file.
